...
$url = 'https://www.ufv.ca/calendar/current/CourseDescriptions/BIO.htm';
...
$course_query = '//div/div/div[@class="col-md-8 ufv-cb"]'; //enter your general query here
...
foreach ($xpath->query($course_query) as $course) {
	...
	*/
	...
	$course_title_query = './/*[contains(@class, "CourseName")]'; //query to find the course title
	...
	$course_faculty_query = './/*[contains(@class, "subjectHeader")]'; //query to find the course faculty
	...
	$course_lettercode_query = './/*[contains(@class, "SubjCode")]'; //query to find the course lettercode
	...
	$course_number_query = './/*[contains(@class, "SubjCode")]'; //query to find the course number
	...
	$course_description_query = './/*[contains(@class, "courseDescription")]'; //query to find the course description
