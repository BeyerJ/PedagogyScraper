...
$url = 'http://www.uottawa.ca/academic/info/regist/calendars/courses/ESP.html';
...
$course_query = '//div/div/table[@id="crsBox"]'; //enter your general query here
...
foreach ($xpath->query($course_query) as $course) {
	...
	*/
	...
	$course_title_query = './/*[contains(@class, "crsTitle")]'; //query to find the course title
	...
	$course_faculty_query = './/*[contains(@id, "TitlePadding")]'; //query to find the course faculty
	...
	$course_lettercode_query = './/*[contains(@class, "crsCode")]'; //query to find the course lettercode
	...
	$course_number_query = './/*[contains(@class, "crsCode")]'; //query to find the course number
	...
	$course_description_query = './/*[contains(@class, "crsDesc")]'; //query to find the course description
