...
//This is for the University of Western Ontario
...
$url = 'http://www.westerncalendar.uwo.ca/2016/pg883.html';
...
$course_query = '//tr[2]/td/div[@class="item-container"]';
...
foreach ($xpath->query($course_query) as $course) {
	...
	*/
	...
	$course_title_query = './/*[contains(@id, "cnCourseName")]'; 
	...
	$course_faculty_query = './/*[contains(@id, "cnCoursePrefix")]'; //query to find the course faculty
	...
	$course_lettercode_query = './/*[contains(@id, "cnSuffix")]'; //query to find the course lettercode
	...
	$course_number_query = './/*[contains(@id, "cnNumber")]'; //query to find the course number
	...
	//unb: could not figure out

	$course_description_query = './/*[contains(@id, "cnDescription")]'; //query to find the course description
